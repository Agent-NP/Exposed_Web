...
import { getTodayData } from "../utils/RequestMaker";
...
export default function Today() {
  ...
  useEffect(() => {
    const fetchMatches = async () => {
      try {
        updateCurrentPage("/today")
        const arrFetchedMatches = await getTodayData(); 
  ...
  return (
    <>
      <div className="pt-2 pb-1 text-center">
        <span className="fs-4 fw-bold">Today Matches</span>
      </div>
